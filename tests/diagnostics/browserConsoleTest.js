...
(function() {
  ...
  if (textModeButton && voiceModeButton) {
    ...
    const textActive = textModeButton.classList.contains('active') ||
                      textModeButton.getAttribute('aria-selected') === 'true';
    const voiceActive = voiceModeButton.classList.contains('active') ||
  ...
  const voiceChat = document.querySelector('[class*="voice-chat"]') ||
