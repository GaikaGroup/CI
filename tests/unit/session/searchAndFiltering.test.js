...
import { highlightText, getSearchExcerpt, containsSearchTerm, getMatchPositions } from '../../../src/lib/modules/session/utils/searchHighlight.js';
...
describe('Search Highlighting Utilities', () => {
  ...
  describe('getSearchExcerpt', () => {
    it('should return excerpt around search term', () => {
      const text = 'This is a very long text with the search term somewhere in the middle of it all';
...
describe('Session Store - Search and Filtering', () => {
  ...
  it('should export activeFiltersCount derived store', async () => {
    const { activeFiltersCount } = await import('../../../src/lib/modules/session/stores/sessionStore.js');
    expect(activeFiltersCount).toBeDefined();
  });

  it('should export hasActiveFilters derived store', async () => {
    const { hasActiveFilters } = await import('../../../src/lib/modules/session/stores/sessionStore.js');
