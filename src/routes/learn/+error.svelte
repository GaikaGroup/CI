    ...
    switch (status) {
      case 404:
        return {
          ...
          details:
            error?.details ||
            'This course may have been removed, renamed, or you may not have access to it.',
          icon: Search,
          suggestions: [
...
<div class="min-h-screen bg-stone-50 dark:bg-gray-900">
  ...
  <div class="bg-white dark:bg-gray-800 border-b border-stone-200 dark:border-gray-700">
    <div class="container mx-auto px-4 py-4">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-xl font-semibold text-stone-900 dark:text-white">Course Error</h1>
  ...
  <div class="container mx-auto px-4 py-12">
    <div class="max-w-2xl mx-auto">
      ...
      <!-- Error Details -->
      <div
        class="bg-white dark:bg-gray-800 rounded-lg border border-stone-200 dark:border-gray-700 p-8 mb-8"
      >
            ...
            <ul class="space-y-2">
              {#each errorInfo.suggestions as suggestion}
                <li class="flex items-start gap-2 text-sm text-stone-600 dark:text-gray-400">
                  <div
                    class="w-1.5 h-1.5 bg-stone-400 dark:bg-gray-500 rounded-full mt-2 flex-shrink-0"
                  ></div>
      ...
      <!-- Course Suggestions -->
      <div
        class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6"
      >
