	...
	try {
		...
		if (course.status !== 'active') {
			...
			throw error(403, {
				...
				details: statusMessages[course.status] || `This course is currently ${course.status} and not accessible.`
			});
		}
		...
		throw error(500, {
			...
			details: 'An unexpected error occurred while loading the course progress. Please try again or contact support if the problem persists.'
		});
	}
}