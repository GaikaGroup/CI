<script>
	...
	import { activeEnrollments, enrollmentStats } from '$lib/modules/courses/stores/enrollmentStore.js';
	...
	<div class="min-h-screen flex items-center justify-center">
		<div class="text-center max-w-md mx-auto px-4">
			<div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
				<h2 class="text-lg font-semibold text-red-800 dark:text-red-200 mb-2">Error Loading Progress</h2>
		...
		<div class="container mx-auto px-4 py-8">
			{#if !courseEnrollment}
				...
				<div class="text-center py-12">
					<div class="bg-white dark:bg-gray-800 rounded-lg border border-stone-200 dark:border-gray-700 p-8 max-w-md mx-auto">
			...
			{:else if progressData}
				...
				<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
					<div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-stone-200 dark:border-gray-700">
						<div class="flex items-center justify-between">
							<div>
								<p class="text-sm font-medium text-stone-600 dark:text-gray-400">Overall Progress</p>
					...
					<div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-stone-200 dark:border-gray-700">
						<div class="flex items-center justify-between">
							<div>
								<p class="text-sm font-medium text-stone-600 dark:text-gray-400">Lessons Completed</p>
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
					<!-- Learning Activity -->
					<div class="bg-white dark:bg-gray-800 rounded-lg border border-stone-200 dark:border-gray-700">
						<div class="p-6 border-b border-stone-200 dark:border-gray-700">
							<h3 class="text-lg font-semibold text-stone-900 dark:text-white">Learning Activity</h3>
						</div>
					...
					<div class="bg-white dark:bg-gray-800 rounded-lg border border-stone-200 dark:border-gray-700">
						<div class="p-6 border-b border-stone-200 dark:border-gray-700">
							<h3 class="text-lg font-semibold text-stone-900 dark:text-white">Course Information</h3>
						</div>
						<div class="p-6 space-y-4">
							<div>
								<p class="text-sm font-medium text-stone-600 dark:text-gray-400 mb-1">Description</p>
								...
								<div>
									...
									<div class="flex flex-wrap gap-2">
										{#each data.course.skills as skill}
											<span class="inline-flex items-center px-2 py-1 text-xs bg-amber-100 dark:bg-amber-800 text-amber-700 dark:text-amber-200 rounded">
												{skill}
											</span>
										{/each}
									</div>
				...
				<!-- Timeline -->
				<div class="mt-8 bg-white dark:bg-gray-800 rounded-lg border border-stone-200 dark:border-gray-700">
					<div class="p-6 border-b border-stone-200 dark:border-gray-700">
