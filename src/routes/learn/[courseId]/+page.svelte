...
<svelte:head>
	...
	<meta name="description" content={data?.course?.description || 'Interactive course learning experience'} />
</svelte:head>
	...
	<div class="min-h-screen flex items-center justify-center">
		<div class="text-center max-w-md mx-auto px-4">
			<div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
				<h2 class="text-lg font-semibold text-red-800 dark:text-red-200 mb-2">Error Loading Course</h2>
