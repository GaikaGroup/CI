<script>
  ...
  const variantClasses = {
    ...
    secondary: 'bg-stone-200 text-stone-800 hover:bg-stone-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600 focus:ring-stone-400 dark:focus:ring-gray-500',
