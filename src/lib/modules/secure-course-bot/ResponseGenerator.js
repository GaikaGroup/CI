...
export class ResponseGenerator {
  constructor() {
    ...
    this.responseTemplates = {
      ...
      prompt_injection_response:
        "I've detected an attempt to override my system instructions. I cannot and will not operate outside my designated role as a course assistant. I'm here to help with [COURSE_NAME] content only. What course-related question can I help you with?",

      authority_claim_response:
        "I cannot verify identity through this chat interface. If you're course staff needing to modify bot functionality, please use the official administrative channels. For [COURSE_NAME] questions, I'm happy to help any student.",

      roleplay_response:
        "I don't participate in roleplaying or hypothetical scenarios designed to bypass my course-focused purpose. I'm here specifically to help with [COURSE_NAME]. What course topic can I assist you with?",

      emotional_manipulation_response:
        "I understand you may be under pressure, but I can only help with [COURSE_NAME] content. For personal or non-course issues, I recommend reaching out to [ACADEMIC_ADVISOR]. For [COURSE_NAME] material help, I'm here for you.",

      chain_of_thought_response:
        "I follow the straightforward principle: is this directly related to [COURSE_NAME] content? The answer is no, so I'll focus on what I can help with regarding the course.",

      // Off-topic responses
      off_topic_response:
        "That's an interesting question, but it falls outside the scope of [COURSE_NAME]. I'm specifically designed to help with our course content, which covers [COURSE_TOPICS]. Is there anything related to [COURSE_SUGGESTIONS] I can help you with instead?",

      repeated_off_topic_response:
        "I've noticed several questions that aren't related to [COURSE_NAME]. I want to be helpful, but I can only assist with course material. If you need help with other subjects or personal matters, I recommend [CAMPUS_RESOURCES]. I'm here when you need help with [COURSE_CONTENT].",

      // Academic integrity responses
      academic_integrity_response:
        "I can't complete assignments for you, as that would violate academic integrity policies. However, I can:\n- Explain relevant concepts\n- Walk through similar examples\n- Help you understand the assignment requirements\n- Point you to relevant course materials\n\nWhat specific concept or part of the assignment would you like to understand better?",

      // Mixed question response
      mixed_question_response:
        "I'll address the course-related parts: [RELEVANT_PARTS]\n\nThe questions about [OFF_TOPIC_ITEMS] are outside course scope, so I've focused on the course content above.",

      // Social engineering response
      social_engineering_response:
        'I maintain the same standards for all users and all questions. I can only help with course-related content.',

      // Escalation response
      escalation_response:
        'This is a question best addressed directly by [PROFESSOR_TA]. You can reach them at [CONTACT_METHOD]. I can help with understanding the course material itself.',
  ...
  substituteParameters(template, courseConfig) {
    ...
    response = response.replace(
      /\[COURSE_TOPICS\]/g,
      courseConfig.courseTopics.slice(0, 3).join(', ')
    );
    ...
    response = response.replace(
      /\[ACADEMIC_ADVISOR\]/g,
      'academic advisor/counseling services/appropriate resource'
    );
