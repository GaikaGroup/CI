<script>
  ...
  $: needsOrchestrationAgent =
    formData.agents?.filter((a) => a.type === AGENT_TYPES.SUBJECT).length > 1;
  ...
  const addOrchestrationAgent = () => {
    const subjectAgents = formData.agents?.filter((a) => a.type === AGENT_TYPES.SUBJECT) || [];
    const instructions = createOrchestrationInstructions(subjectAgents);
      ...
      <div class="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Describe what this subject covers and what learners will gain..."
            rows="4"
            class="w-full rounded-lg border border-stone-300 px-3 py-2 text-stone-900 placeholder-stone-500 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-amber-400"
            required
          ></textarea>
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                  Subjects with multiple agents need an orchestration agent to coordinate responses.
                </p>
              </div>
            ...
            >
              <div class="flex items-center gap-2">
                ...
                <div class="text-sm text-blue-800 dark:text-blue-200">
                  <strong>Privacy Mode:</strong> This subject will only use local LLM providers. No data
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            class="w-full rounded-lg border border-stone-300 px-3 py-2 text-stone-900 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-amber-400"
          >
            <option value={AGENT_TYPES.SUBJECT}>Specialist Agent</option>
          </select>
        </div>
